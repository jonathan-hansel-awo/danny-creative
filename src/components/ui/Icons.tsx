...
export function ArrowLeft({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function Close({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function Menu({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function Plus({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function Mail({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function Phone({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
...
export function MapPin({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn("w-5 h-5", className)}
      fill="none"
